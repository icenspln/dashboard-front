...
type GroupsTableContext = {
    ...
    enrollModal: boolean;
    setEnrollModal: Dispatch<SetStateAction<boolean>>;
    teacherAbsenceModal: boolean;
    setTeacherAbsenceModal: Dispatch<SetStateAction<boolean>>;
};
...
export const GroupsTableContext = createContext<GroupsTableContext>({
    ...
    enrollModal: false,
    setEnrollModal: () => {},
    teacherAbsenceModal: false,
    setTeacherAbsenceModal: () => {},
});
...
export function GroupsTableContextProvider({
    ...
    const [additionalDayModal, setAdditionalDayModal] =
    ...
    const [teacherAbsenceModal, setTeacherAbsenceModal] =
        useState<boolean>(false);
...
export function useGroupsTable() {
    return useContext(GroupsTableContext);
}
